...
12. 吸收与 issue 自主域按 SKILL.md §2 边界表(2026-08-24 用户裁决扩权):任意窗口规模含 >20、含 11 个 servo BCE 文件 patch 重放、issue 任意 scope 含 vendor,均自主执行;mozjs 跨版本升级走 SKILL.md §9 长任务协议(7 天预算跨日结转,起手优先继续 long_running);重放纪律引用 references/upstream-daily.md §5
