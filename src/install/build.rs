...
// ──────────────────────────────────────────────────────────────────────────
// Dual-mode channel probe (stable ⇄ nightly): the facade types this crate
// consumes (bun_core ChanVec / bun_alloc core_alloc AllocVec/AllocBox)
// resolve to the api2 mirrors on stable, so per-arm code here is
// `#[cfg(bao_nightly)]`-split. (bun_core / bun_alloc build.rs template.)
// ──────────────────────────────────────────────────────────────────────────
fn emit_channel_probe() {
