...
impl Lockfile {
    ...
    /// The first package whose dependency list contains `id`.
    /// upstream bun #38867 (875c761d5d); prerequisite of b64b63069c.
    pub fn get_parent_pkg_of_dependency(&self, id: DependencyID) -> Option<PackageID> {
    ...
    /// upstream bun b64b63069c (#33106)
    pub fn is_workspace_declared_package(&self, id: PackageID) -> bool {
        let packages = self.packages.slice();
    ...
    /// upstream bun b64b63069c (#33106)
    pub fn is_trusted_folder_dependency(&self, id: DependencyID) -> bool {
