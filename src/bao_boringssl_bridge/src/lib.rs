...
pub use connection::{
    ...
    SSL_SELECT_CERT_ERROR, SSL_SELECT_CERT_RETRY, SSL_SELECT_CERT_SUCCESS, ssl_cipher_bits,
    ssl_cipher_name, ssl_cipher_version, ssl_peer_cert_info, ssl_peer_certificates_der,
    ssl_protocol_version, ssl_servername,
};
