...
pub mod bv2_impl {
    ...
    pub struct ResolveImportRecordCtx<'a> {
        ...
        /// See `only_selected_record` (upstream 95d406c9ad).
        pub only_records: Option<&'a [u32]>,
    }
    ...
    pub struct PatchImportRecordsCtx<'a> {
        ...
        /// See `only_selected_record` (upstream 95d406c9ad). `Some` also saves the
        /// source indices regardless of dev_server/loader: the barrel BFS follows them.
        pub only_records: Option<&'a [u32]>,
    }
    ...
    impl<'a> BundleV2<'a> {
        ...
        fn generate_server_html_module(
            ...
            let ast_for_html_entrypoint = JSAst::init(
                ...
                .ok_or_else(|| bun_core::err!("ParserError"))?,
            );
    ...
    // upstream 475b885d6e: `pub use crate::AdditionalFile;` had no reader
    // (consumers import it from the crate root) — deleted.
    ...
    // upstream 475b885d6e: `pub use crate::IndexStringMap::IndexStringMap;` had
    // no reader (consumers import it from the crate root module path) — deleted.
    pub use bun_ast::Loc;
