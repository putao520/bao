...
fn test_all_bridge_command_variants_serializable() {
    let commands: Vec<BridgeCommand> = vec![
        ...
        BridgeCommand::DebuggerSetBreakpoint { target_id: TID.into(), url: Some("http://example.com".into()), url_regex: None, line: 10, column: Some(5) },
        BridgeCommand::DebuggerRemoveBreakpoint { target_id: TID.into(), breakpoint_id: "bp-1-10-5".into() },
