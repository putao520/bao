...
pub fn install(cx: &mut mozjs::context::JSContext) {
    ...
    unsafe {
        ...
        let Some(_opts_guard) = crate::compile_options_guard::CompileOptionsGuard::new(mozjs::glue::NewCompileOptions(cx_raw, c"node:string_decoder".as_ptr(), 1) as *mut _) else {
            return;
        };
