...
fn main() {
    ...
    // Include dirs
    build.include(bssl_dir.join("include"));

    // ── BCM ──────────────────────────────────────────────────────────────
    build.file(bssl_dir.join("crypto/fipsmodule/bcm.cc"));

    // ── CRYPTO_SRCS ──────────────────────────────────────────────────────
    const CRYPTO_SRCS: &[&str] = &[
        "crypto/aes/aes.cc",
