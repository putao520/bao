...
/// RFC 9110 §5.5: a parser strips leading and trailing SP / HTAB. HPACK and
/// QPACK do not (upstream bun b8c4a9b629, #43118).
pub fn trim_response_value(value: &[u8]) -> &[u8] {
