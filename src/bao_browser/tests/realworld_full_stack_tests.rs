...
// ---------------------------------------------------------------------------
// Scenario 6 stealth defaults — covered by stealth_fingerprint_e2e_tests.rs
// (JSEngine is process-global, cannot coexist with servo init in same binary)

// Scenario 2/5 originals were folded into scenario_2_data_url_inline_form and
// realworld_full_stack_stealth_data_layer respectively. No separate tests needed.
