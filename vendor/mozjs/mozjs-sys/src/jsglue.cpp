...
// 153 RULING (P6/0046 same-face adjudication, zero-loss): upstream 0046's
// JS::AddServoSizeOf fills a ServoSizes via SimpleJSRuntimeStats — a strict
// subset of what the soak probe consumes (this 7-field POD carries
// zone/realm COUNTS + gcHeapChunkTotal/gcHeapGCThings that
// SimpleJSRuntimeStats never computes). BaoCollectRuntimeStats stays the
// metering path; upstream 0046 serves upstream's own CollectServoSizes.
// Different consumers, no double source.
